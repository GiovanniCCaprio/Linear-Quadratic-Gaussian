...
U=[30;22;16];%estado inicial

norma = [];%armazena a norma do vetor de estados
norma = [norma; norm(U)];
W=[];xk2=[];xk3=[];%armazena individualmente cada elemento do vetor de estados 
W=[W; U(1,1)];xk2=[xk2; U(2,1)];xk3=[xk3; U(3,1)];
...
uk = -M*U; %controle, portanto calculamos o estado seguinte por:
U = A*U + B*uk + B*sqrt(0.04)*noise; %estado atual
W=[W; U(1,1)];xk2=[xk2; U(2,1)];xk3=[xk3; U(3,1)];
norma = [norma;norm(U) ];
yk = C*U;
